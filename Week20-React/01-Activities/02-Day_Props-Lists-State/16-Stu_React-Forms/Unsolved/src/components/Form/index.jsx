...
function Form() {
  ...
  const [password, setPassword] = useState(''); // useState hook
  ...
  const handleInputChange = (e) => {
    ...
    if (inputType === 'email') {
      ...
      setPassword(inputValue); // set password to input value
    }
  };
  ...
  const handleFormSubmit = (e) => {
    ...
    if (!checkPassword(password)) { // checking password
      setErrorMessage(
    ...
    setEmail('');
    setPassword(''); // password state value is empty
    ...
    <div className="container text-center">
      ...
      <form className="form" onSubmit={handleFormSubmit}>
        ...
        <input
          value={password}
          name="password"
          onChange={handleInputChange} // onChange event trigger
          type="password"
