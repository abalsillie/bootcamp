...
--> AS A finance officer, I WANT to see all monthly pays, SO THAT I can ensure our staff are being paid on time, and keep track of our company's financial position

2. Mobile app finds nearby restaurant
--> AS SOMEONE who eats out, I WANT to be able to see all the available restaurants in my area, SO THAT I can make a choice easily for somewhere to eat

3. A reminder app for important tasks
--> AS AN employee, I WANT to have a reminder app, SO THAT I can achieve all upcoming tasks
